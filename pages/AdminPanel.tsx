                      ...
                      <form onSubmit={handleCreateUser} className="space-y-4">
                           ...
                           <div className="grid grid-cols-3 gap-4 bg-slate-50 p-3 rounded-lg">
                               ...
                               <div>
                                   ...
                                   <input type="color" className="w-full h-10 border rounded bg-white cursor-pointer" value={newUserForm.calendarColor} onChange={e => setNewUserForm({...newUserForm, calendarColor: e.target.value})} />
                               </div>
                           </div>
